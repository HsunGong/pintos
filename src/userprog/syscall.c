...
static void syscall_exec(struct intr_frame *, const char *);
static void syscall_wait(struct intr_frame *, pid_t);
static void syscall_open(struct intr_frame *, const char *);
static void syscall_create(struct intr_frame *, const char *, unsigned);
static void syscall_remove(struct intr_frame *, const char *);
static void syscall_filesize(struct intr_frame *, int);
static void syscall_read(struct intr_frame *, int, const void *, unsigned);
static void syscall_write(struct intr_frame *, int, const void *, unsigned);
static void syscall_seek(struct intr_frame *, int, unsigned);
static void syscall_tell(struct intr_frame *, int);
static void syscall_close(struct intr_frame *, int);

bool syscall_check_user_string(const char *);
bool syscall_check_user_buffer(const char *, int, bool);

static struct lock filesys_lock;
#ifdef FILESYS
static void syscall_chdir(struct intr_frame *, const char *);
static void syscall_mkdir(struct intr_frame *, const char *);
static void syscall_readdir(struct intr_frame *, int, char *);
static void syscall_isdir(struct intr_frame *, int);
static void syscall_inumber(struct intr_frame *, int);
#endif
